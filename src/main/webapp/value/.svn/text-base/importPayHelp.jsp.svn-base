...
<head>
	...
	<title>导入成本说明</title>
	<style>
		#memo20150723{margin:20px 0 0 20px;}
		#memo20150723 span{
			color:red;
			font-size:14px;
...
<div class="easyui-panel" data-options="footer: '#dlg-buttons',border:false" fit=true>
	<div id="memo20150723">
		...
		<span style="font-size:16px;color:blue">1.成本导入步骤：</span><br>
		<img src="./images/steppay.jpg"/><br>
  		<span>1）请先从价值管理页面查询需要导入的资产列表，然后导出成本录入模板；</span><br>
  		<span>2）在导出的成本录入模板中录入新增的资产成本；</span><br>
 		<span>3）在本页面中填写合同编号、上传资产成本列表；</span><br><br>
	</div>
</div>
