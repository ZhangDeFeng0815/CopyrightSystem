...
<div class="easyui-layout" data-options="border:false" fit=true>  
	...
	<div id="aa" region="center" title="您现在的位置:合同管理>授权合同" toolbar="#gridToolbar" data-options="border:false">
		<div id="gridToolbar" class="acws-toolbar" enablebtn="btnNew,btnEdit,btnView" disablebtn="">
			<a id="btnNew" class="acws_auth" authids="20000215" iconCls="icon-add"  onclick="onAddClick()">新增</a>
			<a id="btnEdit" class="acws_auth" authids="20000215" iconCls="icon-edit"  onclick="onEditClick()">修改</a>
		...
		<div id="gridDiv" class="acws-grid"
			...
			url="./contract/getContractOutList.ajax"
			...
			<table class="acwsgrid">
				<thead>
					...
					<tr idField=contractId widthunit='%'>
						...
						<td colField=partnerId 		width=14 	align=center	celltype=ro 	sort=str></td>
						<td colField=partnerName 	width=25 	align=left 		celltype=ro 	sort=str></td>
						<td colField=createUserName width=14 	align=center 	celltype=ro 	sort=str></td>
...
//新增
function onAddClick(){
	Acws.showDialog({url:'./contract/contractOutAdd.jsp',title:'授权合同',width:400,height:300,modal:true,
...
function onEditClick(){
	...
	Acws.showDialog({url:'./contract/contractOutEdit.jsp',title:'授权合同',width:400,height:300,modal:true,
...
function onViewClick(){
	...
	var cd = mygrid.getCellValue(id, "contractCd");
	var createUserName = mygrid.getCellValue(id, "createUserName");
	Acws.showDialog({url:'./contract/contractOutView.jsp',title:"授权合同",
