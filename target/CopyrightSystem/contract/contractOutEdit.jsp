	...
	<table id="conditionDiv" class="acws-layout">
		...
		<tr>
			...
			<td class="ts">
			    ...
			    <input id="myfile" class="acws-filebox" service="$contractOutEdit" data-field="fileName"
...
function onAcwsDialogInit(params){
	onInitContractOutInfo(params.cd);
	dlgParams = params;
}

function onInitContractOutInfo(contractCd){
    var inputData = {"contractCd" : contractCd};
    //调用后台获取Grid数据
    Acws.ajax("./contract/viewContractOut.ajax",inputData,function(outputData){
